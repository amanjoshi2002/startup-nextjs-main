  ...
  const projects: Project[] = [
    {
      ...
      category: 'Landing',
      image: '/images/portfolio/weeding.jpg',
  ...
  return (
    <>
     <Breadcrumb
      ...
      />
    <section className="py-24 bg-secondary-50" id="portfolio">
                ...
                <div className="relative aspect-video">
                  ...
                  <div className="absolute inset-0 bg-primary-600/80 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                    <motion.button
                      ...
                      className="bg-white text-primary-600 px-4 py-2 rounded-lg flex items-center gap-2"
                    >
                      View Details
                  ...
                  <div className="grid md:grid-cols-2 gap-6 mb-6">
                    <div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center gap-2">
                          <span className="text-secondary-600">User Rating:</span>
