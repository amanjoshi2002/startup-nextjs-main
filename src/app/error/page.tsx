...
export const metadata: Metadata = {
  title: "Error Page | Next Craft Solution",
  description: "This is the Error Page for Next Craft Solution. The page you were looking for appears to have been moved, deleted, or does not exist.",
  // other metadata
};
            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[530px] text-center">
                ...
                <h3 className="mb-4 text-3xl font-bold text-black dark:text-white sm:text-4xl">
                  Sorry, the page can&rsquo;t be found
                </h3>
